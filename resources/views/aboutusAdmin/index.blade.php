...
<html lang="en">
  ...
  <body>
    <div style="background-color: white">
        ...
        <div class="container">
          <div class="row" style="margin-top: 90px">
            ...
            <div class="col-md-6 mt-5 mb-5">
              <img src="{{ isset($abouts) && $abouts->image ? '/img/' . $abouts->image : '/img/default-image.jpg' }}" alt="" class="w-100"> 
            </div>

            <div class="col-md-4 mt-5 mb-5 text-center align-items-center" style="color: black">
              <img src="{{ isset($abouts) && $abouts->icon1 ? '/img/' . $abouts->icon1 : '/img/default-icon1.jpg' }}" alt="">
              <h5>{{ $abouts->tittle_icon1 ?? 'Default Icon 1 Title' }}</h5>
              <P>{{ $abouts->isi_icon1 ?? 'Default description for Icon 1.' }}</P>
            </div>

            <div class="col-md-4 mt-5 mb-5 text-center align-items-center" style="color: black">
              <img src="{{ isset($abouts) && $abouts->icon2 ? '/img/' . $abouts->icon2 : '/img/default-icon2.jpg' }}" alt="">
              <H5>{{ $abouts->tittle_icon2 ?? 'Default Icon 2 Title' }}</H5>
              <p>{{ $abouts->isi_icon2 ?? 'Default description for Icon 2.' }}</p>
            </div>

            <div class="col-md-4 mt-5 mb-5 text-center align-items-center" style="color: black">
              <img src="{{ isset($abouts) && $abouts->icon3 ? '/img/' . $abouts->icon3 : '/img/default-icon3.jpg' }}" alt="">
              <h5>{{ $abouts->tittle_icon3 ?? 'Default Icon 3 Title' }}</h5>
              <P>{{ $abouts->isi_icon3 ?? 'Default description for Icon 3.' }}</P>
            </div>
    ...
    <form action="{{ route('aboutusAdmin.store') }}" method="POST"  enctype="multipart/form-data">
     ...
     <div class="form-group mt-4">
      ...
      <textarea class="form-control" id="text" name="reason" rows="3">{{ $abouts->reason ?? '' }}</textarea>
   </div>
  
   <div class="form-group mt-4">
    <label for="text" class="form-label d-block">Image</label>
    <label for="formFile" class="form-label mb-3"><img src="{{ isset($abouts) && $abouts->image ? '/img/' . $abouts->image : '/img/default-image.jpg' }}" alt="" style="width: 200px"></label>
    <input class="form-control" type="file" id="formFile" name="image">
  </div>
  
   <div class="form-group mt-4">
    <label for="text" class="form-label d-block">Icon 1</label>
    <label for="formFile" class="form-label mb-3"><img src="{{ isset($abouts) && $abouts->icon1 ? '/img/' . $abouts->icon1 : '/img/default-icon1.jpg' }}" alt="" style="width: 50px"></label>
  ...
  <div class="form-group mt-4">
    ...
    <label for="formFile" class="form-label mb-3"><img src="{{ isset($abouts) && $abouts->icon2 ? '/img/' . $abouts->icon2 : '/img/default-icon2.jpg' }}" alt="" style="width: 50px"></label>
  ...
  <div class="form-group mt-4">
    ...
    <label for="formFile" class="form-label mb-3"><img src="{{ isset($abouts) && $abouts->icon3 ? '/img/' . $abouts->icon3 : '/img/default-icon3.jpg' }}" alt="" style="width: 50px"></label>
