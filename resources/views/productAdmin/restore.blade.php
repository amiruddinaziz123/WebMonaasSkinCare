...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pulih Product</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Pulih Product</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title mt-1">Pulihkan Product <span class="text-bold">{{ old('foto_product', $products->nama_product) }}?</span></h3>
                </div>
                <form action="{{ route('productAdmin.softdeleted', $products->slug_link) }}" method="POST" autocomplete="off" class="needs-validation" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea readonly class="form-control @error('description_product') is-invalid @enderror" id="des" name="description_product" required rows="3">{{ old('description_product', $products->description_product) }}</textarea>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-success">Pulih</button>
